...
const FadeAnimation = preload("res://rengo/infra/animation/implementations/alpha/fade_animation.gd")
const InstantAnimation = preload("res://rengo/infra/animation/implementations/effects/instant_animation.gd")
const TransformAnimation = preload("res://rengo/infra/animation/implementations/transform/transform_animation.gd")
