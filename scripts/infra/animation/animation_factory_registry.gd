...
func _register_builtin_factories() -> void:
	...
	var transform_factory = load("res://scripts/infra/animation/factory/transform_animation_factory.gd").new()
	var state_change_factory = load("res://scripts/infra/animation/factory/state_change_animation_factory.gd").new()
	var shader_factory = load("res://scripts/infra/animation/factory/shader_animation_factory.gd").new()
	var video_factory = load("res://scripts/infra/animation/factory/video_animation_factory.gd").new()
	var instant_factory = load("res://scripts/infra/animation/factory/instant_animation_factory.gd").new()
